# Kick off your SAP HANA App Dev Env for running Hana-Cli (XSA & CF) by leverage VS Code Dev Container. Use this [devcontainer](https://github.com/draschke/tbase/tree/master/.devcontainer) for your projects if you want
...
- (ENV XSCLI="/workspaces/tbase/XS_CLIENT00P_134-70001320)

Change the permission by running your WSL - Distro with the chmod command.

```bash
node ➜ /workspaces/tbase/XS_CLIENT00P_134-70001320/bin (docs ✗)
$ chmod -R +x xs
```

```bash
node ➜ /workspaces/tbase/XS_CLIENT00P_134-70001320/sapjvm_8_jre/ (docs ✗)
$ chmod -R +x bin
```
...
- If you want, use the same Extensions in WSL by running this file [code --install-extension](https://github.com/draschke/tbase/blob/main/install-extensions.txt)
...
- Consider to use [Discussions](https://github.com/draschke/tbase/discussions)
